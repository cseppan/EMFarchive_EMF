...
public class CopyTaskManager implements TaskManager {
    private static Log log = LogFactory.getLog(CopyTaskManager.class);

    private static CopyTaskManager ref;
    ...
    private static ArrayList<CopyCaseSubmitter> submitters = new ArrayList<CopyCaseSubmitter>();
    ...
    public synchronized void registerTaskSubmitter(CopyCaseSubmitter ts) {
        submitters.add(ts);
    }
    ...
    private static synchronized CopyCaseSubmitter getCurrentSubmitter(String submitterId) {
        Iterator<CopyCaseSubmitter> iter = submitters.iterator();
...
//            labels = "=======================================\n";
//            sbuf.append(labels);
//            labels = "Status of the CopyTaskManager\n\n";
//            sbuf.append(labels);
...
//                labels = "There are no tasks in the CopyTaskManager WaitTable\n";
//                sbuf.append(labels);
//
//            } else {
...
//            labels = "=======================================\n";
//            sbuf.append(labels);
//            labels = "Tasks in the CopyTaskManager RunTable\n";
//            sbuf.append(labels);
//            labels = "UserId, Dataset Name\n";
//            sbuf.append(labels);
//
