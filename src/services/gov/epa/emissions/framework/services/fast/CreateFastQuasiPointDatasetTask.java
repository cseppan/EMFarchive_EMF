...
public class CreateFastQuasiPointDatasetTask implements Runnable {

    private static final Log LOG = LogFactory.getLog(CreateFastQuasiPointDatasetTask.class);
    ...
    public CreateFastQuasiPointDatasetTask(User user, FastNonPointDataset fastNonPointDataset,
    ...
    private void endStatus(StatusDAO statusServices) {
        String start = "Finished creating controlled inventories using control strategy '" + fastNonPointDataset.getId() + "'";
