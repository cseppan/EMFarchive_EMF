...
public class GriddedSectorCMAQInventoryPollutantEmissionFileFormat implements FileFormatWithOptionalCols, DelimitedFileFormat {

    protected SqlDataTypes types;

    private FillDefaultValues filler;

    public GriddedSectorCMAQInventoryPollutantEmissionFileFormat(SqlDataTypes types) {
        this(types, new FillRecordWithBlankValues());
    }

    public GriddedSectorCMAQInventoryPollutantEmissionFileFormat(SqlDataTypes types, FillDefaultValues filler) {
        this.types = types;
        this.filler = filler;
    }
    ...
    public Column[] minCols() {
        ...
        cols.add(new Column("TRANSFER_COEFFICIENT", types.stringType(64), 64, new StringFormatter(64)));
