...
//        setStatus("Started running control strategy: " + sectorScenarioTask.getSectorScenario().getName());
//    }
//
//    private void addCompletedStatus() {
//        setStatus("Completed running control strategy: " + sectorScenarioTask.getSectorScenario().getName() + ".");
//    }
//
