...
public class StrategyFactory {
    ...
    public Strategy create(ControlStrategy controlStrategy, User user, HibernateSessionFactory sessionFactory, DbServer dbServer)
            throws EmfException {
        try {
            return doCreate(controlStrategy, user, sessionFactory, dbServer);
        } catch (Exception e) {
    ...
    private Strategy doCreate(ControlStrategy controlStrategy, User user, HibernateSessionFactory sessionFactory, DbServer dbServer)
            throws Exception {
