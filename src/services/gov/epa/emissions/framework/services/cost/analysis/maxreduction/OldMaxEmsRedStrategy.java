...
public class OldMaxEmsRedStrategy implements Strategy {
    ...
    public OldMaxEmsRedStrategy(ControlStrategy strategy, DbServer dbServer, Integer batchSize, HibernateSessionFactory sessionFactory) throws EmfException {
...
//      TODO:
    ...
    private void writeBatchOfData(Dataset inputDataset, int resultDatasetId, ResultSet resultSet,
        ...
        while (resultSet.next()) {
            ...
            try {
                OldRecordGenerator generator = new OldRecordGenerator(inputDataset.getId(), resultDatasetId, resultSet, cm,
                        controlStrategy);
