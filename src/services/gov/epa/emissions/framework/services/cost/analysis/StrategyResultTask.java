...
public class StrategyResultTask implements Runnable {

    private static Log log = LogFactory.getLog(StrategyResultTask.class);

    private User user;

    private StrategySummaryTask strategyResult;
...
//    private HibernateSessionFactory sessionFactory;
    ...
    public StrategyResultTask(StrategySummaryTask strategyResult, User user, 
            Services services, HibernateSessionFactory sessionFactory) {
        this.user = user;
...
//    }
    ...
    private void addStartStatus() {
        setStatus("Started creating control strategy result: " + strategyResult.getStrategyResult().getStrategyResultType().getName());
    }

    private void addCompletedStatus() {
        setStatus("Completed creating control strategy result: " + strategyResult.getStrategyResult().getStrategyResultType().getName() + ".");
    }
