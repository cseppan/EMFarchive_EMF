...
public class NewDataEditorServiceCache {

    private Map readersMap;

    private NewVersionedRecordsReader recordsReader;
    ...
    public NewDataEditorServiceCache(NewVersionedRecordsReader reader, VersionedRecordsWriterFactory writerFactory,
