...
public class DataEditorServiceImpl implements DataEditorService {
    ...
    public Version derive(Version baseVersion, String name) throws EmfException {
        try {
            ...
            log.error("Could not derive a new Version from the base Version: " + baseVersion.getVersion()
                    + " of Dataset: " + baseVersion.getDatasetId() + "\t" + e.getMessage());
    ...
    public Version markFinal(Version derived) throws EmfException {
        try {
            ...
            updateDatasetDefaultVersion(finalVersion);
            return finalVersion;
        } catch (SQLException e) {
            log.error("Could not mark a derived Version: " + derived.getDatasetId() + " as Final" + "\t" + e.getMessage());
