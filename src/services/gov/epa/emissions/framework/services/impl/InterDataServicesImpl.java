...
public class InterDataServicesImpl implements InterDataServices {
    private static Log log = LogFactory.getLog(InterDataServicesImpl.class);

    public InterDataServicesImpl() {
        super();
    }
