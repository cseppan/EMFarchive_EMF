...
/**
 * 
 * @version $Id: TableModifier.java,v 1.1 2005/08/12 14:12:14 rhavaldar Exp $
 */
public class TableModifier {
    ...
    public void createPointSummaryTable(String datasourceName, String emTable, String epTable, String euTable,
        ...
        String query = "CREATE TABLE " + summaryTable + " AS SELECT DISTINCT f." + STATE_COL + " as " + STATE + ", "
                ...
                + referenceDatasource.getName() + ".fips as f, " + epTable + " as ep, " + euTable + " as eu, " + erTable
                + " as er, " + "(SELECT DISTINCT " + FIPS_COL + ", " + FACILITY_COL + ", " + UNIT_COL + ", "
