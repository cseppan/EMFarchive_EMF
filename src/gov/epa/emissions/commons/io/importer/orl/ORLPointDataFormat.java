 ...
 * @version $Id: ORLPointDataFormat.java,v 1.1 2005/08/05 13:14:28 rhavaldar Exp $
 */
public final class ORLPointDataFormat extends ORLDataFormat
{
    ...
    public static final String EMISSIONS_RELEASE_POINT_TYPE_NAME = "ERPTYPE";//not used by SMOKE; 01 = fugitive; 02 = vertical stack; 03 = horiozontal stack; 04 = goose neck; 05 = vertical with rain cap; 06 = downward-facing vent
    ...
    private static final String SOURCE_TYPE_NAME = "SRCTYPE";//01 = major; 02 = Section 12 area source
    ...
    public static final String STACK_GAS_FLOW_RATE_NAME = "STKFLOW";//optional; automatically calculated by Smkinven from velocity and diameter if not given
    ...
    public static final String COORDINATE_SYSTEM_TYPE_NAME = "CTYPE";//U = Universal Transverse Mercator, L = Latitude/Longitude
    ...
    public static final String X_LOCATION_NAME = "XLOC";//if CTYPE = U, Easting value (meters); if CTYPE = L, Longitude (decimal degrees)
    private static final int X_LOCATION_WIDTH = NO_WIDTH;
    private static final ColumnType X_LOCATION_TYPE = ColumnType.REAL;
    public static final String Y_LOCATION_NAME = "YLOC";//if CTYPE = U, Northing value (meters); if CTYPE = L, Latitude (decimal degrees)
    ...
    private static final String CONTROL_EFFICIENCY_NAME = "CEFF";//recommended: SMOKE default value == 0
    ...
    private static final String RULE_EFFECTIVENESS_NAME = "REFF";//recommended: SMOKE default value == 100
    ...
    private static final String PRIMARY_CONTROL_EQUIPMENT_CODE_NAME = "CPRI";//not used by SMOKE
    ...
    private static final String SECONDARY_CONTROL_EQUIPMENT_CODE_NAME = "CSEC";//not used by SMOKE
    ...
    public ORLPointDataFormat(boolean extendedFormat)
    {
    ...
    public FileImportDetails getFileImportDetails()
    {
        ...
        addDetail(details, EMISSIONS_RELEASE_POINT_TYPE_NAME, EMISSIONS_RELEASE_POINT_TYPE_TYPE, EMISSIONS_RELEASE_POINT_TYPE_WIDTH);
        ...
        addDetail(details, STACK_GAS_EXIT_TEMPERATURE_NAME, STACK_GAS_EXIT_TEMPERATURE_TYPE, STACK_GAS_EXIT_TEMPERATURE_WIDTH);
        ...
        addDetail(details, PRIMARY_CONTROL_EQUIPMENT_CODE_NAME, PRIMARY_CONTROL_EQUIPMENT_CODE_TYPE, PRIMARY_CONTROL_EQUIPMENT_CODE_WIDTH);
        addDetail(details, SECONDARY_CONTROL_EQUIPMENT_CODE_NAME, SECONDARY_CONTROL_EQUIPMENT_CODE_TYPE, SECONDARY_CONTROL_EQUIPMENT_CODE_WIDTH);
