...
public class DatabaseSetup {
    ...
    private DbServer createMySqlDbServer(Properties pref) {
        ...
        emissionsParams = createConnectionParams(pref.getProperty("datasource.emissions.name"), pref
                ...
                .getProperty("datasource.emissions.password"), pref.getProperty("database.emissions.host"), pref
                .getProperty("datasource.emissions.port"));

        referenceParams = createConnectionParams(pref.getProperty("datasource.reference.name"), pref
                .getProperty("datasource.reference.name"), pref.getProperty("datasource.reference.username"), pref
                .getProperty("datasource.reference.password"), pref.getProperty("datasource.reference.host"), pref
                .getProperty("datasource.reference.port"));
