 ...
 * @version $Id: TableTypes.java,v 1.4 2005/08/25 21:00:09 rhavaldar Exp $
 */
public final class TableTypes {
    ...
    // getAllNames(IDAMobileTableTypes.class);
    /** List of all objects in enumeration. */
    // public static final java.util.List VALUES =
    // getInstances(NIFPointTableTypes.class);
    /** */
    ...
    static {
        ...
        DATASET_TYPE_TO_NAMES_ARRAY_MAP.put(DatasetTypes.IDA_AREA, new String[] { IDA_AREA });
        DATASET_TYPE_TO_NAMES_ARRAY_MAP.put(DatasetTypes.IDA_MOBILE_EMISSIONS, new String[] { IDA_MOBILE_EMISSIONS });
        DATASET_TYPE_TO_NAMES_ARRAY_MAP.put(DatasetTypes.IDA_MOBILE_ACTIVITY, new String[] { IDA_MOBILE_ACTIVITY });
        DATASET_TYPE_TO_NAMES_ARRAY_MAP.put(DatasetTypes.IDA_POINT, new String[] { IDA_POINT });
        DATASET_TYPE_TO_NAMES_ARRAY_MAP.put(DatasetTypes.NIF_AREA, new String[] { NIF_AREA_CE, NIF_AREA_EM,
                NIF_AREA_EP, NIF_AREA_PE, NIF_AREA_SUMMARY });
        DATASET_TYPE_TO_NAMES_ARRAY_MAP.put(DatasetTypes.NIF_POINT, new String[] { NIF_POINT_CE, NIF_POINT_EM,
                NIF_POINT_EP, NIF_POINT_ER, NIF_POINT_EU, NIF_POINT_PE, NIF_POINT_SI, NIF_POINT_SUMMARY });
        DATASET_TYPE_TO_NAMES_ARRAY_MAP.put(DatasetTypes.NIF_MOBILE_EMISSIONS, new String[] { NIF_MOBILE_EMISSIONS_EM,
                NIF_MOBILE_EMISSIONS_PE, NIF_MOBILE_EMISSIONS_SUMMARY });
        DATASET_TYPE_TO_NAMES_ARRAY_MAP.put(DatasetTypes.REFERENCE, new String[] { REF_CONTROL_DEVICE_CODES,
                REF_CONVERSION_FACTORS, /* REF_COUNTRIES, */
                REF_EMISSION_TYPES, REF_EMISSION_UNITS_CODES, REF_FIPS, REF_MACT_CODES, REF_MATERIAL_CODES,
                REF_NAICS_CODES, REF_POLLUTANT_CODES, /* REF_POLLUTANTS, */REF_SCC,
                /* REF_SECTORS, */REF_SIC_CODES, /* REF_STATES, */REF_TIME_ZONES, REF_TRIBAL_CODES });
        DATASET_TYPE_TO_NAMES_ARRAY_MAP.put(DatasetTypes.ORL_AREA_NONPOINT_TOXICS, new String[] {
        ...
        DATASET_TYPE_TO_NAMES_ARRAY_MAP.put(DatasetTypes.ORL_ON_ROAD_MOBILE_TOXICS, new String[] { ORL_MOBILE_TOXICS,
        ...
        filenameToTableTypeMap = new HashMap();
        // TODO keithlee - make sure this is what NIF mobile onroad files should
        // have in their name, otherwise, lookup via getTableType() won't work
        // (used in FormatttedImporter checkFiles())
        filenameToTableTypeMap.put("onroad_em", NIF_MOBILE_EMISSIONS_EM);
        filenameToTableTypeMap.put("onroad_pe", NIF_MOBILE_EMISSIONS_PE);
        DATASET_TYPE_TO_MAP_OF_FILENAME_TO_TABLE_TYPE_MAP
                .put(DatasetTypes.NIF_MOBILE_EMISSIONS, filenameToTableTypeMap);
        filenameToTableTypeMap = new HashMap();
    ...
    public static final String[] DEFAULT_NIF_AREA_NAMES = { "nei_area_ce", "nei_area_em", "nei_area_ep", "nei_area_pe",
            "nei_area_summary" };

    public static final String[] DEFAULT_NIF_POINT_NAMES = { "nei_point_ce", "nei_point_em", "nei_point_ep",
            "nei_point_er", "nei_point_eu", "nei_point_pe", "nei_point_si", "nei_point_summary" };

    public static final String[] DEFAULT_NIF_MOBILE_EMISSIONS_NAMES = { "nei_onroad_em", "nei_onroad_pe",
            "nei_onroad_summary" };
