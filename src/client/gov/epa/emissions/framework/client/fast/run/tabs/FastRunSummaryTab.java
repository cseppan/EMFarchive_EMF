...
public class FastRunSummaryTab extends AbstractFastRunTab {
    ...
    public FastRunSummaryTab(FastRun run, EmfSession session, MessagePanel messagePanel,
    ...
    protected void populateFields() {
        ...
        this.nameField.setText(getNonNullText(run.getName()));
        this.abbreviationField.setText(getNonNullText(run.getAbbreviation()));
        this.descriptionField.setText(getNonNullText(run.getDescription()));
        this.creatorValueLabel.setText(getNonNullText(run.getCreator().getUsername()));
        this.startTimeValueLabel.setText(this.formatDate(run.getStartDate()));
        this.endTimeValueLabel.setText(this.formatDate(run.getCompletionDate()));
        this.lastModifiedTimeValueLabel.setText(this.formatDate(run.getLastModifiedDate()));
        this.lastModifiedByValueLabel.setText(run.getCreator().getUsername());
    }
