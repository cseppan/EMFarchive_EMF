...
public class FastAnalysisManagerWindow extends AbstractMPSDTManagerTab implements FastAnalysisManagerView, Runnable {
    ...
    public FastAnalysisManagerWindow(EmfConsole parentConsole, EmfSession session, DesktopManager desktopManager) {
    ...
    private void doLayout(FastAnalysis[] analyses, EmfSession session) {
        ...
        this.add(createTablePanel(analyses, getParentConsole(), session), BorderLayout.CENTER);
        this.add(createControlPanel(), BorderLayout.SOUTH);
    }

    private JPanel createTablePanel(FastAnalysis[] analyses, EmfConsole parentConsole, EmfSession session) {

        this.table = new SelectableSortFilterWrapper(parentConsole, new FastAnalysisTableData(analyses), SORT_CRITERIA);
    ...
    protected JPanel createButtonPanel() {
        ...
        Button newButton = new NewButton(
                new AbstractFastAction(this.getMessagePanel(), "Error creating Fast analysis") {
        ...
        Button copyButton = new CopyButton(
                new AbstractFastAction(this.getMessagePanel(), "Error copying Fast analyses") {
        ...
        Button analyzeButton = new Button("Analyze", new AbstractFastAction(this.getMessagePanel(),
                "Error running Fast analyses") {
    ...
    private SelectAwareButton editButton(ConfirmDialog confirmDialog) {
        ...
        Action editAction = new AbstractFastAction(this.getMessagePanel(), "Error editing Fast analyses") {
    ...
    private SelectAwareButton viewButton(ConfirmDialog confirmDialog) {
        ...
        Action viewAction = new AbstractFastAction(this.getMessagePanel(), "Error viewing Fast analyses") {
    ...
    private void viewAnalyses() {
        ...
        List<IdProducer> analyses = getSelected();
        if (analyses.isEmpty()) {
            this.showMessage(ROOT_SELECT_PROMPT + "view.");
        } else {
            for (IdProducer analysis : analyses) {
    ...
    private void removeAnalyses() throws EmfException {
        ...
        this.clearMessage();
        final List<IdProducer> analyses = getSelected();
        ...
        if (analyses.isEmpty()) {
            ...
            if (size == 1) {
                ...
                message = "Are you sure you want to remove the " + size + " selected Fast analyses?";
            }
    ...
    private void runAnalyses() throws EmfException {
        ...
        if (analyses.isEmpty()) {
            ...
            if (size == 1) {
                ...
                message = "Are you sure you want to run the " + size + " selected Fast analyses?";
            }
    ...
    private void exportAnalyses() throws EmfException {
        ...
        if (analyses.isEmpty()) {
            ...
            if (size == 1) {
                ...
                message = "Are you sure you want to export the " + size + " selected Fast analyses?";
            }
            ...
            if (selection == JOptionPane.YES_OPTION) {
                ...
                ExceptionHandlingCommand exportCommand = new AbstractCommand(this) {
                    public void execute() throws EmfException {
    ...
    private void copyAnalyses() throws EmfException {
        ...
        if (analyses.isEmpty()) {
            ...
            if (size == 1) {
                ...
                message = "Are you sure you want to copy the " + size + " selected Fast analyses?";
            }
            ...
            if (selection == JOptionPane.YES_OPTION) {
                ...
                ExceptionHandlingCommand saveCommand = new AbstractCommand(this) {
                    public void execute() throws EmfException {
                        ...
                        for (int id : ids) {
                            presenter.doSaveCopiedAnalysis(id, getSession().user());
                        }
                    }
                };
    ...
    private List<IdProducer> getSelected() {
        return (List<IdProducer>) table.selected();
    }
}
