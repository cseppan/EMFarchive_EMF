...
public class FastRunManagerPresenterImpl implements RefreshObserver, FastRunManagerPresenter {
    ...
    public FastRunManagerPresenterImpl(EmfSession session, FastRunManagerView view) {
    ...
    public void doNew() throws EmfException {
        ...
        FastRunView creatorView = new FastRunCreatorWindow(this.view.getDesktopManager(), session, this.view
                .getParentConsole());
        FastRunPresenter presenter = new FastRunCreatorPresenterImpl(session, creatorView, this);
        presenter.doDisplay();
    ...
    public void doEdit(FastRun fastRun) throws EmfException {
        ...
        FastRunView editorView = new FastRunEditorWindow(this.view.getDesktopManager(), session, this.view
                .getParentConsole());
        FastRunPresenter presenter = new FastRunEditorPresenterImpl(fastRun.getId(), session, editorView, this);
        presenter.doDisplay();
    }
    ...
    public void doSaveCopiedRun(FastRun fastRun, User creator) throws EmfException {
        service().copyFastRun(fastRun.getId(), this.session.user());
    }

    public void doExecuteRuns(List<FastRun> fastRuns, User creator) throws EmfException {
