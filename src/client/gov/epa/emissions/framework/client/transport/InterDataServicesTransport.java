...
public class InterDataServicesTransport implements InterDataServices {
    private static Log log = LogFactory.getLog(InterDataServicesTransport.class);

    private String endpoint;

    public InterDataServicesTransport(String endPoint) {
        endpoint = endPoint;
    }
...
//    }
    ...
    public Keyword[] getKeywords() throws EmfException {
     try {
          ...
          KeywordMappings mappings = new KeywordMappings();
          mappings.register(call);
