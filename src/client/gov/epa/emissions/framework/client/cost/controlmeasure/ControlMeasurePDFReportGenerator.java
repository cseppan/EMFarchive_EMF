...
public class ControlMeasurePDFReportGenerator {
    ...
    private void createEquationsSection(Document document) throws DocumentException, EmfException {
    ...
    private void createEfficiencyRecordsSection(Document document) throws DocumentException, EmfException {

        this.createSectionTitle(document, "Efficiency Records");
        ...
        if (efficiencyRecords == null || efficiencyRecords.length == 0) {
            ...
            PdfPCell pollutantCell = new PdfPCell(new Phrase("Pollutant", BOLD_FONT));
            pollutantCell.setHorizontalAlignment(Element.ALIGN_LEFT);
            pollutantCell.setVerticalAlignment(Element.ALIGN_CENTER);
            pollutantCell.setBorderColor(borderColor);
            pollutantCell.setPadding(5);
            pollutantCell.setBackgroundColor(BaseColor.GRAY.brighter());
            // nameCell.setUseBorderPadding(true);
            table.addCell(pollutantCell);

            PdfPCell localeCell = new PdfPCell(new Phrase("Locale", BOLD_FONT));
            localeCell.setHorizontalAlignment(Element.ALIGN_LEFT);
            localeCell.setVerticalAlignment(Element.ALIGN_CENTER);
            localeCell.setBorderColor(borderColor);
            localeCell.setPadding(5);
            localeCell.setBackgroundColor(BaseColor.GRAY.brighter());
            // descCell.setUseBorderPadding(true);
            table.addCell(localeCell);

            PdfPCell effectiveDateCell = new PdfPCell(new Phrase("Effective Date", BOLD_FONT));
            effectiveDateCell.setHorizontalAlignment(Element.ALIGN_LEFT);
            effectiveDateCell.setVerticalAlignment(Element.ALIGN_CENTER);
            effectiveDateCell.setBorderColor(borderColor);
            effectiveDateCell.setPadding(5);
            effectiveDateCell.setBackgroundColor(BaseColor.GRAY.brighter());
            // descCell.setUseBorderPadding(true);
            table.addCell(effectiveDateCell);

            PdfPCell costYearCell = new PdfPCell(new Phrase("Cost Year", BOLD_FONT));
            costYearCell.setHorizontalAlignment(Element.ALIGN_LEFT);
            costYearCell.setVerticalAlignment(Element.ALIGN_CENTER);
            costYearCell.setBorderColor(borderColor);
            costYearCell.setPadding(5);
            costYearCell.setBackgroundColor(BaseColor.GRAY.brighter());
            // descCell.setUseBorderPadding(true);
            table.addCell(costYearCell);

            PdfPCell costPerTonCell = new PdfPCell(new Phrase("Cost/Ton", BOLD_FONT));
            costPerTonCell.setHorizontalAlignment(Element.ALIGN_LEFT);
            costPerTonCell.setVerticalAlignment(Element.ALIGN_CENTER);
            costPerTonCell.setBorderColor(borderColor);
            costPerTonCell.setPadding(5);
            costPerTonCell.setBackgroundColor(BaseColor.GRAY.brighter());
            // descCell.setUseBorderPadding(true);
            table.addCell(costPerTonCell);

            for (EfficiencyRecord efficiencyRecord : efficiencyRecords) {

                pollutantCell = new PdfPCell(new Phrase(efficiencyRecord.getPollutant().getName(), REGULAR_FONT));
                pollutantCell.setHorizontalAlignment(Element.ALIGN_LEFT);
                pollutantCell.setVerticalAlignment(Element.ALIGN_CENTER);
                pollutantCell.setBorderColor(borderColor);
                pollutantCell.setPadding(5);
                ...
                localeCell = new PdfPCell(new Phrase(efficiencyRecord.getLocale(), REGULAR_FONT));
                localeCell.setHorizontalAlignment(Element.ALIGN_LEFT);
                localeCell.setVerticalAlignment(Element.ALIGN_CENTER);
                localeCell.setBorderColor(borderColor);
                localeCell.setPadding(5);
                ...
                Date effectiveDate = efficiencyRecord.getEffectiveDate();
                effectiveDateCell = new PdfPCell(new Phrase(effectiveDate != null ? effectiveDate.toString()
                        : N_A_STRING, REGULAR_FONT));
                effectiveDateCell.setHorizontalAlignment(Element.ALIGN_LEFT);
                effectiveDateCell.setVerticalAlignment(Element.ALIGN_CENTER);
                effectiveDateCell.setBorderColor(borderColor);
                ...
                costYearCell = new PdfPCell(new Phrase(this.getIntegerAsString(efficiencyRecord.getCostYear()),
                        REGULAR_FONT));
                costYearCell.setHorizontalAlignment(Element.ALIGN_LEFT);
                costYearCell.setVerticalAlignment(Element.ALIGN_CENTER);
                costYearCell.setBorderColor(borderColor);
                ...
                costPerTonCell = new PdfPCell(new Phrase(this.getDoubleAsString(efficiencyRecord.getCostPerTon()),
                        REGULAR_FONT));
                costPerTonCell.setHorizontalAlignment(Element.ALIGN_LEFT);
                costPerTonCell.setVerticalAlignment(Element.ALIGN_CENTER);
                costPerTonCell.setBorderColor(borderColor);
    ...
    private void createAlternateEfficiencyRecordsSection(Document document) throws DocumentException, EmfException {
        ...
        if (efficiencyRecords == null || efficiencyRecords.length == 0) {
            ...
            int labelHAlign = Element.ALIGN_LEFT;
            int labelVAlign = Element.ALIGN_CENTER;
            int valueHAlign = Element.ALIGN_LEFT;
            ...
            for (EfficiencyRecord efficiencyRecord : efficiencyRecords) {
                ...
                table.setWidthPercentage(100);
                table.setTotalWidth(new float[] { 150, 110, 130, 80, 130, 80 });
                table.getDefaultCell().setBorderColor(borderColor);
