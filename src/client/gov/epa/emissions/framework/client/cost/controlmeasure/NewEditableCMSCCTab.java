...
public class NewEditableCMSCCTab extends JPanel implements EditableCMTabView {

    private EditableTablePanel panel;

    private SCCTableData tableData;

    public NewEditableCMSCCTab(ControlMeasure measure, EmfSession session, ManageChangeables changeables,
