...
public class CopyQAStepTemplateToDatasetSelectionDialog extends JDialog implements CopyQAStepTemplateToDatasetSelectionView {

//    private EmfConsole parent;

    private CopyQAStepTemplateToDatasetSelectionPresenter presenter;
    ...
    public CopyQAStepTemplateToDatasetSelectionDialog(EmfConsole parent) {
        super(parent);
...
//        this.parent = parent;
    ...
    private JPanel buildNameContains(){
        ...
        layoutGenerator.addLabelWidgetPair("Replace QA Step?  ", replaceCheckBox, panel);
    ...
    public void observe(CopyQAStepTemplateToDatasetSelectionPresenter presenter) {
