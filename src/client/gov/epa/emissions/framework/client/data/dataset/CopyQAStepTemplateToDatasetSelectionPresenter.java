...
public class CopyQAStepTemplateToDatasetSelectionPresenter {

    private EmfSession session;

    private CopyQAStepTemplateToDatasetSelectionView view;
    
    private DatasetType[] datasetTypesToInclude;

    public CopyQAStepTemplateToDatasetSelectionPresenter(CopyQAStepTemplateToDatasetSelectionView view, EmfSession session,
