...
public class TextParser {
    ...
    public void parse(){
        ...
        try{
            ...
            if(fields[0].equalsIgnoreCase("number") &&
               fields[1].equalsIgnoreCase("path") &&
               fields[2].equalsIgnoreCase("groups") &&
               fields[3].equalsIgnoreCase("date") &&
               fields[4].equalsIgnoreCase("version") &&
               fields[5].equalsIgnoreCase("size")){
                //TODO:
            } else {
