...
public class InstallWindow extends JFrame implements InstallView {
    ...
    public void display() {
        try {
            ...
            throw new RuntimeException("Could not display Installer. Reason: " + e.getMessage());
        }
        setVisible(true);
    }
    ...
    private class InstallButtonListener implements ActionListener {
        public void actionPerformed(ActionEvent e) {
            ...
            try {
                ...
                throw new RuntimeException("Could not Install. Reason: " + e1.getMessage());
            }
            presenter.createBatchFile(installhome + "\\" + Generic.EMF_BATCH_FILE, installhome + "\\"
                    + Generic.EMF_PARAMETER, installhome, javahome);
    ...
    public void displayErr(String err) {
        presenter.stopDownload();
        JOptionPane.showMessageDialog(this, err, "File Downloading Error", JOptionPane.WARNING_MESSAGE);
    }
