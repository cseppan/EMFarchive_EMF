...
public class DatasetTypeKeyValueTableDataTest extends TestCase {

    private DatasetTypeKeyValueTableData data;
    ...
    protected void setUp() {
        ...
        data = new DatasetTypeKeyValueTableData(new KeyVal[] { val1, val2 });
    }
