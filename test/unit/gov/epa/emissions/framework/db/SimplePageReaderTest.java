...
public class SimplePageReaderTest extends MockObjectTestCase {
    ...
    public void testPageCountShouldBeTotalRecordsByPageSize() throws Exception {
        ...
        SimplePageReader reader = new SimplePageReader(3, (ScrollableRecords) scrollableRecords.proxy());
    ...
    public void testPageCountShouldIncludeTheLastPageWhichCouldBeSparse() throws Exception {
        ...
        SimplePageReader reader = new SimplePageReader(10, (ScrollableRecords) scrollableRecords.proxy());
