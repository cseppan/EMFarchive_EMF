...
public class NInvDiffProgramQueryTest extends ServiceTestCase {
    ...
    public void testOfQueryThroughRunner() throws Exception {
        ...
        try {
            ...
            qaStep.setProgramArguments("-inventories\ntest\ntest2\ntest3\n-invtable\ninvtable\n-summaryType\nState");

            dbServer = dbServerFactory.getDbServer();
            //String emissioDatasourceName = dbServer().getEmissionsDatasource().getName();
            //this will set the properties...
            //new ExImServiceImpl(emf(), dbServer, sessionFactory);
            SQLNInvDiffProgramQuery query = new SQLNInvDiffProgramQuery(sessionFactory, emissioDatasourceName, tableName,
                    qaStep);
            //runner.query();
