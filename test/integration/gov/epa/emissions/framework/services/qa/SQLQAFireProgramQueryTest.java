...
public class SQLQAFireProgramQueryTest extends ServiceTestCase {
    ...
    public void testOfQueryThroughRunner() throws Exception {
        ...
        try {
            ...
            SQLQAFireProgramQuery query = new SQLQAFireProgramQuery(sessionFactory, emissioDatasourceName, tableName,
                    qaStep);
            //runner.query();
            System.out.println(query.createFireProgramQuery());
        } catch (Exception e) {
