...
public class MultiInvdiffProgramQueryTest extends ServiceTestCase {
    ...
    public void testOfQueryThroughRunner() throws Exception {
        ...
        try {
            ...
            qaStep.setProgramArguments("-inventories_base\ntest\ntest2\n-inventories_compare\ntest3\n-invtable\n\n-summaryType\nState");

            dbServer = dbServerFactory.getDbServer();
            //String emissioDatasourceName = dbServer().getEmissionsDatasource().getName();
            //this will set the properties...
            //new ExImServiceImpl(emf(), dbServer, sessionFactory);
            SQLMultiInvDiffProgramQuery query = new SQLMultiInvDiffProgramQuery(sessionFactory, emissioDatasourceName, tableName,
                    qaStep);
            //runner.query();
            System.out.println(query.createInvDiffProgramQuery());
        } catch (Exception e) {
